...
export default function EditStoreScreen() {
  ...
  const { id } = useLocalSearchParams(); // Get store ID from route params
  ...
  useEffect(() => {
    if (autoGenerateCode && storeName && !isEditMode) {
  ...
  const handleSaveStore = async () => {
    ...
    try {
      ...
      Alert.alert('Error', error.response?.data?.message || 'Failed to save store. Please try again.');
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput
              style={[styles.input, (autoGenerateCode && !isEditMode) && styles.inputDisabled]}
              placeholder="Store code"
              placeholderTextColor={COLORS.textMuted}
              value={storeCode}
              onChangeText={setStoreCode}
              editable={!autoGenerateCode || isEditMode}
            />
          </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.mapHint}>
            💡 Tap on the map to place a marker or drag the existing marker to reposition
          </Text>
        </View>
        ...
        >
          {isLoading ? (
            ...
            <>
              ...
              <Text style={styles.saveButtonText}>{isEditMode ? 'Update Store' : 'Save Store'}</Text>
            </>
          )}
        </TouchableOpacity>
